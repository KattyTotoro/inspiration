...
export const usePosts = defineStore('posts', () => {
  const posts = [
    {id: 3, rubric: '', title: 'Третья стратья', title_en:'', text: 'Text 1 ВДОХНОВЕНИЕ - это Видеть, слышать, чувствовать…. Восхвалять творение, быть его частью ежесекундно! Приглашаем вместе учиться ведать Божественные энергии, делиться Радостью и Знаниями.', preview: 'third Peview ВДОХНОВЕНИЕ - это Видеть, слышать, чувствовать….', 
    ...
    {id: 1, rubric: '', title: 'First post', title_en:'', text: 'Text 3 Text text text text ВДОХНОВЕНИЕ - это Видеть, слышать, чувствовать…. Восхвалять творение, быть его частью ежесекундно! Приглашаем вместе учиться ведать Божественные энергии, делиться Радостью и Знаниями.', preview: 'Peview...', img: 'summary_large_image.png', datetime: '2024-12-12', author: 'Petrov',
      reactions:{
        smile:0,
        sad:0,
      }},
